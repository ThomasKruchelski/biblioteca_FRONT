...
export default function Home() {
    ...
    useEffect(() => {
        const fetchLivros = async () => {
            try {
                const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/livros/editora/${queryParams.nome}`, {
                    method: 'GET',
                    headers: {
            ...
            <div class="flex min-h-screen">
                <aside class="bg-white w-64 p-6">
                    ...
                    <nav>
                        <ul>
                            ...
                            <div className="flex flex-col pt-4">
                                <li class="mb-4 text-purple-600 font-medium flex items-center font-semibold">
                                    {/* <a href="#" className="text-gray-600 font-medium flex items-center font-semibold"> */}
                                    Editoras
                                    {/* </a> */}
                                </li>
                ...
                <main class="flex-1 p-8">
                    <header class="flex justify-between items-center mb-8">
                        <h1 class="text-2xl font-semibold">Livros de {querynome}</h1>
